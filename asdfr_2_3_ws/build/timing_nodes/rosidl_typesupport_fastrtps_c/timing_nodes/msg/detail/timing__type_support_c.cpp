...
#include "timing_nodes/msg/detail/timing__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_timing_nodes
...
using _Timing__ros_msg_type = timing_nodes__msg__Timing;
...
size_t get_serialized_size_timing_nodes__msg__Timing(
  ...
  size_t current_alignment)
{
  const _Timing__ros_msg_type * ros_message = static_cast<const _Timing__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = timing_nodes__msg__Timing;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const timing_nodes__msg__Timing * ros_message = static_cast<const timing_nodes__msg__Timing *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_timing_nodes__msg__Timing(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  timing_nodes__msg__Timing * ros_message = static_cast<timing_nodes__msg__Timing *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_timing_nodes__msg__Timing(cdr, ros_message);
}

static uint32_t _Timing__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_timing_nodes__msg__Timing(
...
static size_t _Timing__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_timing_nodes__msg__Timing(
...
static message_type_support_callbacks_t __callbacks_Timing = {
  "timing_nodes::msg",
  "Timing",
...
static rosidl_message_type_support_t _Timing__type_support = {
