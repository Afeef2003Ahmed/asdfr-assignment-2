...
bool timing_nodes__msg__timing__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("timing_nodes.msg._timing.Timing", full_classname_dest, 31) == 0);
  }
  timing_nodes__msg__Timing * ros_message = _ros_message;
  {  // id
...
PyObject * timing_nodes__msg__timing__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("timing_nodes.msg._timing");
